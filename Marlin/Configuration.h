...
#define STRING_CONFIG_H_AUTHOR "ACKMANIAC X5S" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKi 24.66
  #define DEFAULT_bedKd 625.98
